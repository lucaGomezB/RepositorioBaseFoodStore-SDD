...
- [x] 2.1 Test refresh endpoint with valid token (requires seeded DB)
- [x] 2.2 Test refresh endpoint invalidates old token (rotation)
- [x] 2.3 Test logout endpoint revokes refresh token
- [x] 2.4 Test refresh with revoked token returns 401
