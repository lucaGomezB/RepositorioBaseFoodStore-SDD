...
class ProductoService:
    ...
    @staticmethod
    def create(session: Session, data: dict) -> Producto:
    ...
    def get_all(
        ...
        if categoria_id is not None:
            ...
            cat_product_ids = set(session.exec(cat_stmt).all())
    ...
    @staticmethod
    def get_detalle_publico(session: Session, producto_id: int):
    ...
    @staticmethod
    def update(session: Session, producto_id: int, data: dict):
        """Update a product."""
        repo = ProductoRepository(session)
    ...
    @staticmethod
    def actualizar_stock(session: Session, producto_id: int, cantidad: int):
        """
    ...
    @staticmethod
    def add_ingrediente(session: Session, producto_id: int, data: dict):
    ...
    @staticmethod
    def add_categoria(session: Session, producto_id: int, data: dict):
    ...
    @staticmethod
    def reemplazar_ingredientes(session: Session, producto_id: int, ingredientes: list[dict]):
    ...
    @staticmethod
    def reemplazar_categorias(session: Session, producto_id: int, categorias: list[dict]):
