...
class PerfilService:
    ...
    @staticmethod
    def get_profile(uow: "UnitOfWork", usuario_id: int) -> Usuario:
        ...
        """
        repo = BaseRepository(Usuario, uow.session)
    ...
    @staticmethod
    def update_profile(uow: "UnitOfWork", usuario_id: int, data: dict) -> Usuario:
        """Update user profile.
